...
public class SharedPreferencesUtil {
    ...
    /// @see User
    public static void saveUser(Context context, com.gal.project.models.User user) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(PREF_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
    ...
    public static com.gal.project.models.User getUser(Context context) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(PREF_NAME, Context.MODE_PRIVATE);
        ...
        return new com.gal.project.models.User(uid, fName, lName, phone, email, password);
    }
